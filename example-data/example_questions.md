...
| What was the highest scoring game that the 1s achieved in the 2020-2021 season? | NumberCard           | FASiteData  | {questionType} was the {statIndicator} {statType_1} game that the {entity_1} achieved in the {entity_2} season? |
...
| What's the longest consecutive streak of weekends that I've played in a row?    | Calendar             | StatsData   | {questionType} the {statIndicator} {timeFrame} that {entity_1} {statType_1} in a row? | 
| Who did the fourth team play on the first weekend of 2023?                      | NumberCard           | FASiteData  | {questionType} did the {entity_1} play on the {timeFrame}? |
| How many double game weeks have I played?                                       | NumberCard           | StatsData   | {questionType} {statType_1} have {entity_1} played? |
| How many clean sheets have I had in a row?                                      | Calendar             | StatsData   | {questionType} {statType_1} have {entity_1} had in a row? |

...
export const csvHeaderConfigs: CSVHeaderConfig[] = [
    {
        ...
        expectedHeaders: ['Version Number', 'Version Release Details', 'Updates To Come', 'Last Updated Stats', 'Page Details Last Refreshed', 'Current Season', 'Stat Limitations', 'Stat Details'],
  ...
  },
  {
    ...
    expectedHeaders: ['SEASON FIX ID', 'DATE', 'TEAM', 'COMP TYPE', 'COMPETITION', 'OPPOSITION', 'HOME/AWAY', 'RESULT', 'HOME SCORE', 'AWAY SCORE', 'STATUS', 'OPPO OWN GOALS', 'FULL RESULT', 'DORKINIANS GOALS', 'CONCEDED'],
  ...
  {
    name: 'TBL_WeeklyTOTW',
    expectedHeaders: ['SEASONWEEKNUMREF', 'TOTW SCORE', 'PLAYER COUNT', 'STAR MAN', 'STAR MAN SCORE', 'GK1', 'DEF1', 'DEF2', 'DEF3', 'DEF4', 'DEF5', 'MID1', 'MID2', 'MID3', 'MID4', 'MID5', 'FWD1', 'FWD2', 'FWD3'],
    description: 'Weekly team of the week selections with player positions'
  },
  {
    name: 'TBL_SeasonTOTW',
    expectedHeaders: ['DATE LOOKUP', 'TOTW SCORE', 'STAR MAN', 'STAR MAN SCORE', 'GK1', 'DEF1', 'DEF2', 'DEF3', 'DEF4', 'DEF5', 'MID1', 'MID2', 'MID3', 'MID4', 'MID5', 'FWD1', 'FWD2', 'FWD3'],
    description: 'Season-end team of the year selections'
  },
  {
    name: 'TBL_PlayersOfTheMonth',
    expectedHeaders: ['SEASONMONTHREF', '#1 Name', '#1 Points', '#2 Name', '#2 Points', '#3 Name', '#3 Points', '#4 Name', '#4 Points', '#5 Name', '#5 Points'],
...

  {
    ...
    expectedHeaders: ['Item', 'HTML ID', '2016/17', '2017/18', '2018/19', '2019/20', '2020/21', '2021/22', '2022/23', '2023/24', '2024/25', '2025/26', '2026/27'],

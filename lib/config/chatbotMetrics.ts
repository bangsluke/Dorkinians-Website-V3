...
export const metricConfigs: MetricConfig[] = [
	...
	{
		key: "PS-PSC",
		displayName: "penalties scored in penalty shootout",
		singular: "penalty scored in penalty shootout",
		plural: "penalties scored in penalty shootout",
		aliases: ["penalty shootout scored", "ps scored", "shootout penalty scored", "penalty shootout goal", "ps goal", "penalty shootout conversion"],
		description: "Penalties scored in penalty shootout",
	},
	{
		key: "PS-PM",
		displayName: "penalties missed in penalty shootout",
		singular: "penalty missed in penalty shootout",
		plural: "penalties missed in penalty shootout",
		aliases: ["penalty shootout missed", "ps missed", "shootout penalty missed", "penalty shootout failure", "ps failure"],
		description: "Penalties missed in penalty shootout",
	},
	{
		key: "PS-PSV",
		displayName: "penalties saved in penalty shootout",
		singular: "penalty saved in penalty shootout",
		plural: "penalties saved in penalty shootout",
		aliases: ["penalty shootout saved", "ps saved", "shootout penalty saved", "penalty shootout stop", "ps stop"],
		description: "Penalties saved in penalty shootout (goalkeeper)",
	},
	{
		key: "FTP",
	...
	{
		key: "FORM_CURRENT",
		displayName: "current form (EWMA)",
		singular: "current form score",
		plural: "current form scores",
		aliases: [
			"form_current",
			"current form",
			"my form",
		...
		description: "Reactive EWMA form (match rating / fantasy points) from seeded Player aggregates",
	},
	{
		key: "CURRENT_SCORING_STREAK",
		displayName: "current scoring streak",
		singular: "game scoring streak",
		plural: "games scoring streak",
		aliases: [
		...
		description: "Consecutive games with a goal for primary XI",
	},
	{
		key: "CURRENT_WIN_STREAK",
		displayName: "current win streak",
		singular: "game win streak",
		plural: "games win streak",
		aliases: ["current_win_streak", "current win streak", "winning run", "wins in a row"],
		description: "Consecutive wins for primary XI",
	},
	{
		key: "CURRENT_APPEARANCE_STREAK",
		displayName: "current appearance streak",
		singular: "game appearance streak",
		plural: "games appearance streak",
		aliases: [
			"current_appearance_streak",
			"current appearance streak",
			"appearances in a row",
			"apps in a row",
			"playing streak",
		],
		description: "Consecutive appearances for primary XI",
	},
	{
		key: "CURRENT_ASSIST_STREAK",
		displayName: "current assist streak",
		singular: "game assist streak",
		plural: "games assist streak",
		aliases: ["current_assist_streak", "current assist streak", "assists in a row", "assist run"],
		description: "Consecutive games with an assist",
	},
	{
		key: "CURRENT_CLEAN_SHEET_STREAK",
		displayName: "current clean sheet streak",
		singular: "game clean sheet streak",
		plural: "games clean sheet streak",
		aliases: [
		...
		description: "Consecutive clean sheets (where applicable)",
	},
	{
		key: "CURRENT_GOAL_INVOLVEMENT_STREAK",
		displayName: "current goal involvement streak",
		singular: "game goal involvement streak",
		plural: "games goal involvement streak",
		aliases: [
			"current_goal_involvement_streak",
			"current goal involvement streak",
			"goal involvements in a row",
			"g+a streak",
			"goals or assists streak",
		],
		description: "Consecutive games with a goal or assist",
	},
	{
		key: "ALL_TIME_BEST_SCORING_STREAK",
		displayName: "all-time best scoring streak",
		singular: "game all-time scoring streak",
		plural: "games all-time scoring streak",
		aliases: [
			"all_time_best_scoring_streak",
			"longest scoring streak",
			"best scoring streak",
			"record scoring streak",
			"ever scoring streak",
		],
		description: "Best consecutive scoring games recorded",
	},
	{
		key: "ALL_TIME_BEST_WIN_STREAK",
		displayName: "all-time best win streak",
		singular: "game all-time win streak",
		plural: "games all-time win streak",
		aliases: ["all_time_best_win_streak", "longest win streak", "best win streak", "record win streak"],
		description: "Best consecutive wins recorded",
	},
	{
		key: "ALL_TIME_BEST_APPEARANCE_STREAK",
		displayName: "all-time best appearance streak",
		singular: "game all-time appearance streak",
		plural: "games all-time appearance streak",
		aliases: [
			"all_time_best_appearance_streak",
			"longest appearance streak",
			"longest apps streak",
			"best appearance streak",
		],
		description: "Longest consecutive appearances recorded",
	},
	{
		key: "ALL_TIME_BEST_CLEAN_SHEET_STREAK",
		displayName: "all-time best clean sheet streak",
		singular: "game all-time clean sheet streak",
		plural: "games all-time clean sheet streak",
		aliases: [
			"all_time_best_clean_sheet_streak",
			"longest clean sheet streak",
			"best clean sheet streak",
		],
		description: "Best consecutive clean sheets recorded",
	},
	{
		key: "DIST",
	...
	// Additional metrics for comprehensive question support
	{
		key: "GI",
		displayName: "goal involvements",
		singular: "goal involvement",
		plural: "goal involvements",
		aliases: ["goal involvement", "goal involvements", "goals and assists", "contributions"],
		description: "Goals and assists combined",
	},
	{
		key: "DOUBLE_GAME_WEEKS",
		displayName: "double game weeks",
		singular: "double game week",
		plural: "double game weeks",
		aliases: ["double game week", "double game weeks", "dgw", "multiple games"],
		description: "Weeks with multiple games played",
	},
	{
		key: "CONSECUTIVE_GOALS",
		displayName: "consecutive goals",
		singular: "consecutive goal",
		plural: "consecutive goals",
		aliases: ["consecutive goals", "goals in a row", "scoring streak"],
		description: "Goals scored in consecutive games",
	},
	{
		key: "CONSECUTIVE_ASSISTS",
		displayName: "consecutive assists",
		singular: "consecutive assist",
		plural: "consecutive assists",
		aliases: ["consecutive assists", "assists in a row", "assisting streak"],
		description: "Assists provided in consecutive games",
	},
	{
		key: "CONSECUTIVE_CLEAN_SHEETS",
		displayName: "consecutive clean sheets",
		singular: "consecutive clean sheet",
		plural: "consecutive clean sheets",
		aliases: ["consecutive clean sheets", "clean sheets in a row", "shutout streak"],
		description: "Clean sheets kept in consecutive games",
	},
	{
		key: "MILESTONE_100_GOALS",
		displayName: "100 goal milestone",
		singular: "100 goal milestone",
		plural: "100 goal milestones",
		aliases: ["100 goals", "century", "100 goal mark", "hundred goals"],
		description: "Reaching 100 career goals",
	},
	{
		key: "MILESTONE_50_APPS",
		displayName: "50 appearance milestone",
		singular: "50 appearance milestone",
		plural: "50 appearance milestones",
		aliases: ["50 appearances", "fifty apps", "50 app mark"],
		description: "Reaching 50 career appearances",
	},
	{
		key: "PENALTY_CONVERSION_RATE",
		displayName: "penalty conversion rate",
		singular: "penalty conversion rate",
		plural: "penalty conversion rates",
		aliases: ["penalty rate", "penalty percentage", "penalty success rate"],
		description: "Percentage of penalties successfully converted",
	},
	{
		key: "PENALTY_RECORD",
		displayName: "penalty record",
		singular: "penalty record",
		plural: "penalty records",
		aliases: ["penalty stats", "penalty performance", "spot kick record"],
		description: "Overall penalty taking statistics",
	},
	{
		key: "HOME_AWAY_RATIO",
		displayName: "home vs away ratio",
		singular: "home vs away ratio",
		plural: "home vs away ratios",
		aliases: ["home away ratio", "home away split", "venue distribution"],
		description: "Ratio of home to away games",
	},
	{
		key: "TOP_PLAYER_MONTH",
		displayName: "top player of the month",
		singular: "top player of the month",
		plural: "top players of the month",
		aliases: ["top player", "best player", "player of month", "monthly top"],
		description: "Top performing player in a specific month",
	},
	{
		key: "TOTW_WEEK",
		displayName: "team of the week",
		singular: "team of the week",
		plural: "teams of the week",
		aliases: ["totw", "weekly team", "week team", "weekly selection"],
		description: "Weekly team of the week selections",
	},
	{
		key: "OPPOSITION_GOALS",
		displayName: "goals against opposition",
		singular: "goal against opposition",
		plural: "goals against opposition",
		aliases: ["goals vs", "goals against", "scored against"],
		description: "Goals scored against specific opposition",
	},
	{
		key: "TEAM_GOALS",
		...
		singular: "team goal",
		plural: "team goals",
		aliases: ["team scoring", "team goals", "goals for team"],
		description: "Goals scored for a specific team",
	},
	{
		key: "SEASON_GOALS",
		displayName: "season goals",
		singular: "season goal",
		plural: "season goals",
		aliases: ["seasonal goals", "goals in season", "yearly goals"],
		description: "Goals scored in a specific season",
	},
	{
		key: "WEEKEND_GAMES",
		displayName: "weekend games",
		singular: "weekend game",
		plural: "weekend games",
		aliases: ["weekend matches", "weekend appearances", "weekend play"],
		description: "Games played on weekends",
	},
	{
		key: "CONSECUTIVE_WEEKENDS",
		displayName: "consecutive weekends",
		singular: "consecutive weekend",

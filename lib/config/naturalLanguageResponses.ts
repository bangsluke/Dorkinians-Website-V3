...
export const verbMappings: { [key: string]: VerbMapping[] } = {
	G: [
		{ verb: "scored", alternativeVerbs: ["scored", "got", "achieved"], context: "goals" },
	],
	A: [
		{ verb: "provided", alternativeVerbs: ["achieved", "got", "assisted"], context: "assists" },
	],
	APP: [
		{ verb: "played", alternativeVerbs: ["played", "made", "appeared in", "achieved"], context: "appearances" },
	],
	MIN: [

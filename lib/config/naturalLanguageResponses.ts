...
export const verbMappings: { [key: string]: VerbMapping[] } = {
	...
	MperG: [{ verb: "averages", alternativeVerbs: ["averages", "takes"], context: "minutes per goal scored" }],
	MperCLS: [{ verb: "takes on average", alternativeVerbs: ["takes on average", "needs"], context: "minutes to keep a clean sheet" }],

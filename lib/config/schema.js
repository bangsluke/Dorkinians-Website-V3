 ...
 * 
 * Auto-synced on 2025-09-20T10:51:39.474Z
 */
/**
 * Master
...
const relationships = {
  ...
  // Temporal relationships for streak and consecutive analysis
  CONSECUTIVE_MATCHES: {
    from: 'Player',
    to: 'MatchDetail',
    type: 'CONSECUTIVE_MATCHES',
    properties: {
      streakType: { type: 'string', required: true }, // 'goals', 'assists', 'clean_sheets', 'appearances'
      streakLength: { type: 'integer', default: 1 },
  ...
  // Location-based relationships for home/away analysis
  PLAYED_AT_LOCATION: {
    from: 'Player',
    to: 'MatchDetail',
    type: 'PLAYED_AT_LOCATION',
    properties: {
  ...
  // Milestone tracking relationships
  ACHIEVED_MILESTONE: {
    from: 'Player',
    to: 'MatchDetail',
    type: 'ACHIEVED_MILESTONE',
    properties: {
      milestoneType: { type: 'string', required: true }, // '100_goals', '50_appearances', etc.
      milestoneValue: { type: 'integer', required: true },

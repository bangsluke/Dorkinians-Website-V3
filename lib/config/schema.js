 ...
 *
 * Auto-synced on 2025-10-03T17:27:34.872Z
 */
/**
 * Master
...
const relationships = {
	...
	IN_WEEKLY_TOTW: {
		...
		conditions:
			"p.playerName IN [wt.gk1, wt.def1, wt.def2, wt.def3, wt.def4, wt.def5, wt.mid1, wt.mid2, wt.mid3, wt.mid4, wt.mid5, wt.fwd1, wt.fwd2, wt.fwd3]",
	},
	IN_SEASON_TOTW: {
		from: "Player",
		to: "SeasonTOTW",
		...
		conditions:
			"p.playerName IN [st.gk1, st.def1, st.def2, st.def3, st.def4, st.def5, st.mid1, st.mid2, st.mid3, st.mid4, st.mid5, st.fwd1, st.fwd2, st.fwd3]",
	},
	...
	HAS_CAPTAIN_AWARDS: {
		...
		conditions:
			"p.playerName IN [ca.clubCaptain, ca.firstXICaptains, ca.secondXICaptains, ca.thirdXICaptains, ca.fourthXICaptains, ca.fifthXICaptains, ca.sixthXICaptains, ca.seventhXICaptains, ca.eighthXICaptains, ca.vetsCaptain, ca.playerOfTheSeason, ca.youngPlayerOfTheSeason, ca.goldenBoot, ca.mostImprovedPlayer, ca.newcomerOfTheYear, ca.alanLambertSportsmanship, ca.chairmansCup, ca.peterMillsVolunteers, ca.goalkeeperOfTheYear, ca.firstXISquadPlayer, ca.secondXISquadPlayer, ca.thirdXISquadPlayer, ca.fourthXISquadPlayer, ca.fifthXISquadPlayer, ca.sixthXISquadPlayer, ca.seventhXISquadPlayer, ca.eighthXISquadPlayer, ca.vetsSquadPlayer]",
	},
	HAS_MATCH_DETAILS: {
		from: "Fixture",
		to: "MatchDetail",
	...
	PLAYED_AGAINST_OPPONENT: {
		...
		conditions:
			"EXISTS { MATCH (p)-[:PLAYED_IN]->(md:MatchDetail)<-[:HAS_MATCH_DETAILS]-(f:Fixture) WHERE toLower(trim(f.opposition)) = toLower(trim(od.opposition)) }",
	},
};

 ...
 *
 * Auto-synced on 2025-08-29T11:10:44.468Z
 */
/**
 * Master
...
const relationships = {
	...
	HAS_CAPTAIN_AWARDS: {
		...
		conditions:
			"p.playerName IN [ca.award201617, ca.award201718, ca.award201819, ca.award202021, ca.award202122, ca.award202223, ca.award202324, ca.award202425, ca.award202526, ca.award202627]",
	},
	HAS_MATCH_DETAILS: {
		from: "Fixture",
		to: "MatchDetail",
	...
	TEAM_OPPOSITION_DATE: {
		from: "Team",
		to: "OppositionDetail",
		type: "TEAM_OPPOSITION_DATE",
		properties: {},
		conditions: "EXISTS { MATCH (f:Fixture {team: t.name, opposition: od.opposition}) }",
	},
	SEASON_BOUNDARIES: {
		from: "Season",
		to: "Season",
		type: "SEASON_BOUNDARIES",
		properties: {},
		conditions: "s1.season < s2.season",
	},
};

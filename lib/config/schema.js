...
const relationships = {
  ...
  WON_WEEKLY_TOTW: {
    ...
    properties: {},
    conditions: 'p.playerName = wt.playerName'
  },
  WON_SEASON_TOTW: {
    from: 'Player',
    to: 'SeasonTOTW',
    ...
    properties: {},
    conditions: 'p.playerName = st.playerName'
  },
  WON_PLAYER_OF_THE_MONTH: {
    ...
    properties: {},
    conditions: 'p.playerName = pm.playerName'
  },
  HAS_CAPTAIN_AWARDS: {
    from: 'Player',
    to: 'CaptainAndAward',
    ...
    properties: {},
    conditions: 'p.playerName = ca.playerName'
  },
  HAS_MATCH_DETAILS: {
    from: 'Fixture',
    to: 'MatchDetail',
  ...
  PLAYS_AGAINST: {
    ...
    type: 'PLAYS_AGAINST',
    properties: {},
    conditions: 'p.playerName IS NOT NULL AND od.oppositionName IS NOT NULL'
  }
};

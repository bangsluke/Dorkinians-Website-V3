 ...
 * 
 * Auto-synced on 2025-08-29T09:08:34.525Z
 */
/**
 * Master
...
const relationships = {
  ...
  IN_WEEKLY_TOTW: {
    ...
    properties: {
      ...
      ftpScore: { type: 'integer', default: null },
  ...
  IN_PLAYER_OF_THE_MONTH: {
    ...
    properties: {
      position: { type: 'string', default: null },
      monthlyPoints: { type: 'integer', default: null }
    },
  ...
  PLAYED_WITH: {
    ...
    conditions: 'EXISTS { MATCH (p1:Player {playerName: p.playerName})-[:PLAYED_IN]->(md:MatchDetail) MATCH (p2:Player {playerName: p2.playerName})-[:PLAYED_IN]->(md) WHERE p1.playerName < p2.playerName }'
  },

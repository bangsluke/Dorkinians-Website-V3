			...
			<motion.div
				...
				<div className='flex items-center justify-between mb-6'>
					<div className='flex items-center space-x-3'>
						...
						<h2 className='text-xl font-bold text-gray-900'>{feedbackType === "bug" ? "Report a Bug" : "Request a Feature"}</h2>
					</div>
					<button
						onClick={handleClose}
					...
					<div className='flex bg-gray-100 rounded-lg p-1'>
						<button
							...
							className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-md transition-all ${
								feedbackType === "bug" ? "bg-white text-dorkinians-blue shadow-sm" : "text-gray-600 hover:text-gray-900"
							}`}>
						...
						<button
							...
							className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-md transition-all ${
								feedbackType === "feature" ? "bg-white text-dorkinians-blue shadow-sm" : "text-gray-600 hover:text-gray-900"
							}`}>
				...
				<form onSubmit={handleSubmit} className='space-y-4'>
					...
					<div>
						...
						/>
						<p className='text-xs text-gray-500 mt-1'>This helps me follow up if I have questions</p>
					</div>
					...
					{submitStatus === "success" && (
						<div className='p-3 bg-green-50 border border-green-200 rounded-md'>
							<p className='text-sm text-green-800'>Thank you! Your {feedbackType === "bug" ? "bug report" : "feature request"} has been sent.</p>
						</div>
					)}

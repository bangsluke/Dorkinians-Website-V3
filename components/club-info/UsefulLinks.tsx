								...
								<motion.a
									...
									<div className='flex items-start justify-between'>
										<div className='flex-1'>
											<h4 className='text-sm md:text-base font-medium text-white group-hover:text-yellow-300 transition-colors'>
												{link.title}
											</h4>
											<p className='text-xs md:text-sm text-yellow-100 mt-1'>
												{link.description}
											</p>
										</div>
										<svg 

...
export default function RankingTableSkeleton() {
	return (
		<>
			<p className='text-lg md:text-xl font-bold text-dorkinians-yellow mb-0 pb-0 leading-none'>
				<Skeleton height={20} width="50%" />
				<Skeleton height={16} width="40%" className="mt-1 mx-auto block" />
			</p>
			<div className='overflow-x-auto mt-0'>
				<table className='w-full text-white mt-0 pt-0'>
					<thead>

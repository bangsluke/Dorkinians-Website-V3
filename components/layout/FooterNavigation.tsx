					...
					return (
						<motion.div
							...
							<button
								...
								className={`w-full flex flex-col items-center justify-center space-y-1.5 md:space-y-0 md:space-x-2 md:flex-row px-4 py-2 rounded-xl border-none outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dorkinians-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-transparent ${
									isActive ? "text-dorkinians-yellow-text" : "text-[var(--color-text-primary)] hover:text-dorkinians-yellow-text-hover hover:bg-[var(--color-surface)]"
								}`}
								style={isActive ? { backgroundColor: 'rgba(249, 237, 50, 0.2)' } : undefined}>

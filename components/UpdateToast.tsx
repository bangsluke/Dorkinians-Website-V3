			...
			<motion.div
							...
							<div className='flex items-center justify-between'>
								<div className='flex items-center space-x-3'>
									...
									<div>
										...
										<p className='text-white/80 text-sm'>Version {updateInfo.version} is ready to install</p>
										{updateInfo.releaseNotes && <p className='text-white/60 text-xs mt-1'>{updateInfo.releaseNotes}</p>}
									</div>
								</div>
								<motion.button
				...
				{showDismissMessage && (
					<motion.div
						...
						<p className='text-white text-sm'>You can update any time from the settings screen</p>
					</motion.div>
				)}
			</motion.div>
		</AnimatePresence>

...
const schema = {
  ...
  TBL_SiteDetails: {
    csvColumns: {
      ...
      'Last Seeded Stats': 'lastSeededStats',
      'Current Season': 'currentSeason',
      'Latest Gameweek': 'latestGameweek',
      'Latest Gameweek Date': 'latestGameweekDate',
      ...
      'LeagueTable Node Count': 'leagueTableNodeCount',
    ...
    properties: {
      ...
      latestGameweek: { type: 'string', required: false },
      latestGameweekDate: { type: 'string', required: false },
      ...
      lastSeededStats: { type: 'string', required: false },
      ...
      leagueTableNodeCount: { type: 'integer', required: false },
  ...
  TBL_Players: {
    csvColumns: {
      ...
      'PSV': 'penaltiesSaved',
      'PS-PSC': 'penaltyShootoutPenaltiesScored',
      'PS-PM': 'penaltyShootoutPenaltiesMissed',
      'PS-PSV': 'penaltyShootoutPenaltiesSaved',
      'FTP': 'fantasyPoints',
    ...
    properties: {
      ...
      penaltyShootoutPenaltiesScored: { type: 'integer', required: false },
      penaltyShootoutPenaltiesMissed: { type: 'integer', required: false },
      ...
      currentUnbeatenStreak: { type: 'integer', required: false },
      ...
      seasonBestUnbeatenStreak: { type: 'integer', required: false },
      ...
      maxPenaltiesInGame: { type: 'integer', required: false },
      maxGoalsInGame: { type: 'integer', required: false },
      maxAssistsInGame: { type: 'integer', required: false },
      doubleHattrickCount: { type: 'integer', required: false },
      assistGoalComboCount: { type: 'integer', required: false },
      winsWhenStarting: { type: 'integer', required: false },
      winsFromBench: { type: 'integer', required: false },
      winsWhenScoring: { type: 'integer', required: false },
      seasons20GI: { type: 'integer', required: false },
      maxFantasyPointsInSeason: { type: 'number', required: false },
      derbyWinsReigations: { type: 'integer', required: false },
      betrayalWinsDorkinians: { type: 'integer', required: false },
      leagueTitles: { type: 'integer', required: false },
      cupTitles: { type: 'integer', required: false },
      allTimeBestHighRatingStreak: { type: 'integer', required: false },
  ...
  TBL_MatchDetails: {
    ...
    properties: {
      ...
      season: { type: 'string', required: true },
      seasonWeek: { type: 'string', required: true },
      seasonMonth: { type: 'string', required: true },
      date: { type: 'date', required: true },
      team: { type: 'string', required: true },
      playerName: { type: 'string', required: true },
      minutes: { type: 'integer', required: false },
  ...
  TBL_WeeklyTOTW: {
    ...
    properties: {
      ...
      dateLookup: { type: 'string', required: false },
  ...
  TBL_TestData: {
    csvColumns: {
      ...
      '2020/21Goals': 'goals202021',
      '2021/22Goals': 'goals202122',
      '2022/23Goals': 'goals202223',
      '2023/24Goals': 'goals202324',
      '2024/25Goals': 'goals202425',
      '2025/26Goals': 'goals202526',
      'MostProlificSeason': 'mostProlificSeason',
      'GK': 'gk',
      'DEF': 'def',
      'MID': 'mid',
    ...
    properties: {
      ...
      goals202021: { type: 'integer', required: false },
      goals202122: { type: 'integer', required: false },
      goals202223: { type: 'integer', required: false },
      goals202324: { type: 'integer', required: false },
      goals202425: { type: 'integer', required: false },
      goals202526: { type: 'integer', required: false },
      mostProlificSeason: { type: 'string', required: false },
      gk: { type: 'integer', required: false },
      def: { type: 'integer', required: false },
      mid: { type: 'integer', required: false },

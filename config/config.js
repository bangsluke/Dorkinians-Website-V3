...
exports.statObject = exports.generateLeagueLinks = exports.visualizationTypes = exports.questionTypes = exports.usefulLinks = exports.homepageQuestions = exports.appConfig = void 0;
exports.appConfig = {
    version: "1.1.10",
    name: "Dorkinians FC",
...
const generateLeagueLinks = () => {
    ...
    const leagueSources = dataSources.filter((source) => source.type === "FASiteData" &&
    ...
    const teamLeagues = leagueSources.reduce((acc, source) => {
    ...
    return Object.values(teamLeagues).map((source) => ({
...
exports.generateLeagueLinks = generateLeagueLinks;
...
exports.default = exports.homepageQuestions;

...
export const allExampleQuestions: string[] = [
	...
	"How many goals has Sam Slade got for the 3s whilst playing at home between 20/03/2022 and 21/10/24?",
	...
	"How many players scored 5+ goals for the 1s in the 2021/22 season?",
	...
	"What is my longest assiting run of games?",
	...
	"What's my best season for goals?",

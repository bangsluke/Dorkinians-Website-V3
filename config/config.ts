...
export const statObject = {
	...
	TeamTotalAppearances: {
		statName: "totalAppearances",
		displayText: "Total Player Appearances",
		shortText: "Tot Apps",
		wordedText: "total player appearances",
		statFormat: "Integer",
		description: "The total number of player appearances across all matches for the team.",
		statHigherBetterBoolean: true,
		numberDecimalPlaces: 0,
		statCategory: "Team Stat",
		iconName: "Appearance-Icon",
	...
	TeamTotalGoals: {
		statName: "totalGoals",
		displayText: "Total Player Goals",
		shortText: "Tot Goals",
		wordedText: "total player goals",
		statFormat: "Integer",
		description: "The total number of goals scored by all players for the team.",
		statHigherBetterBoolean: true,
		numberDecimalPlaces: 0,
		statCategory: "Team Stat",
		iconName: "Goals-Icon",
	...
	TeamTotalAssists: {
		...
		displayText: "Total Player Assists",
		shortText: "Tot Assists",
		wordedText: "total player assists",
		statFormat: "Integer",
		description: "The total number of assists provided by all players for the team.",
		statHigherBetterBoolean: true,
		numberDecimalPlaces: 0,
		statCategory: "Team Stat",
		iconName: "Assists-Icon",
	...
	TeamTotalMOM: {
		statName: "totalMOM",
		displayText: "Total Man of the Matches",
		shortText: "Tot MoMs",
		wordedText: "total man of the matches",
		statFormat: "Integer",
		description: "The total number of man of the match awards earned by players for the team.",
		statHigherBetterBoolean: true,
		numberDecimalPlaces: 0,
		statCategory: "Team Stat",
		iconName: "MoM-Icon",
	},
	TeamGoalsPerAppearance: {
		statName: "goalsPerAppearance",
		displayText: "Goals Per Appearance",
		shortText: "G/App",
		wordedText: "goals per appearance",
		statFormat: "Decimal2",
		description: "The average number of goals scored per player appearance for the team.",
		statHigherBetterBoolean: true,
		numberDecimalPlaces: 2,
		statCategory: "Team Stat",
		iconName: "Goals-Icon",

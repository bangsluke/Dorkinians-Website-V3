...
| Area        | Notes                                                                                                                                                                                                 |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Product** | **Most Connected** removed end-to-end (Player Stats nav, UI, `playerData.mostConnected`, helper `lib/stats/mostConnected.ts`, related tests). Co-appearance context remains on **Partnerships** only. |
| **Reason**  | Reduce duplication with partnerships data; simplify graph-insight surface area.                                                                                                                      |

### Player Stats + chatbot integration (2026-03-31)

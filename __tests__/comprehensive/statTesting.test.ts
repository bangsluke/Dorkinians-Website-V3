...
describe('Comprehensive Stat Testing', () => {
  ...
  describe('Advanced Statistics Coverage', () => {
    const advancedStats = [
      'AllGSC', 'GperAPP', 'CperAPP', 'MperG', 'MperCLS', 'FTPperAPP', 'DIST'
    ];
  ...
  describe('Home/Away Statistics Coverage', () => {
    const homeAwayStats = [
      'HomeGames', 'HomeWins', 'HomeGames%Won', 'AwayGames', 'AwayWins', 
      'AwayGames%Won', 'Games%Won'
    ];
  ...
  describe('Team-Specific Appearances Coverage', () => {
    const teamAppStats = [
      '1sApps', '2sApps', '3sApps', '4sApps', '5sApps', '6sApps', '7sApps', '8sApps',
      'MostPlayedForTeam', 'NumberTeamsPlayedFor'
    ];
  ...
  describe('Team-Specific Goals Coverage', () => {
    const teamGoalStats = [
      '1sGoals', '2sGoals', '3sGoals', '4sGoals', '5sGoals', '6sGoals', '7sGoals', '8sGoals',
      'MostScoredForTeam'
    ];
